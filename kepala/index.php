...
<body id>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-8AA65A sidebar " id="bg-custom">
            ...
            <li class="nav-item">
                <a class="nav-link" href="riwayatk.php">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                        ...
                        $sql = "SELECT * FROM formulir WHERE status = 'diproses'";
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($value['tanggal_mulai']) ?></td>
                            <td><?= htmlspecialchars($value['tanggal_selesai']) ?></td>
                            <td><?= htmlspecialchars($value['jenis_cuti']) ?></td>
                            <td><?= htmlspecialchars($value['jumlah_cuti']) ?></td>
                            <td><?= htmlspecialchars($value['alasan']) ?></td>
                            <td>
                                <a href="reviewkepala.php?id_formulir=<?= $value['id_formulir'] ?>" class="btn">
