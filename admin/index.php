...
<body id>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-8AA65A sidebar " id="bg-custom">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="data_K.php" >
                    <i class="fas fa-file-alt text-white"></i>
        ...
        <nav class="navbar navbar-expand navbar-light topbar navbar-custom">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Button -->
                    <button>
                    <a href="tambahdataP.php" class="btn btn-primary p-2 text-white float-right"><i class="fas fa-plus mr-2"></i>Tambah Data Pegawai</a>
                    </button>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="editdata.php?id_user=<?php echo $value['id_user']; ?>" class="btn"><i class="fas fa-edit mr-2"></i> Ubah</a>
                                    <a href="hapusdata.php?id_user=<?php echo $value['id_user']; ?>" class="btn-delete"><i class="fas fa-trash-alt mr-2" onclick="return confirmDelete();"></i> Hapus</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
